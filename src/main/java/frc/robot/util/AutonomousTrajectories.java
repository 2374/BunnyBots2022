...
public class AutonomousTrajectories {
        ...
        private final Trajectory fiveBallTwoPreloadOrangePartOne;
        private final Trajectory fiveBallTwoPreloadOrangePartTwo;
        private final Trajectory fiveBallTwoPreloadOrangePartThree;
        ...
        public AutonomousTrajectories(TrajectoryConstraint[] trajectoryConstraints) {
                ...
                fenderRedPartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-1.119, 0.618), Rotation2.fromDegrees(-21.0))
                                                .arcTo(new Vector2(-1.598, 1.096), new Vector2(-0.820, 1.396),
                                                                Rotation2.fromDegrees(-21.0))
                                                .lineTo(new Vector2(-2.434, 3.265), Rotation2.fromDegrees(24.0))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                fenderBluePartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-0.290, -1.245), Rotation2.fromDegrees(69.0))
                                                .arcTo(new Vector2(-0.246, -1.926), new Vector2(0.475, -1.538),
                                                                Rotation2.fromDegrees(69.0))
                                                .lineTo(new Vector2(0.474, -3.265), Rotation2.fromDegrees(24.0))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                twoBallGreenPartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-2.386, 0.669), Rotation2.fromDegrees(1.5))
                                                .arcTo(new Vector2(-4.356, 1.897), new Vector2(-2.327, 2.956),
                ...
                twoBallPurplePartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-1.765, -1.581), Rotation2.fromDegrees(46.5))
                                                .arcTo(new Vector2(-3.477, -3.268), new Vector2(-3.472, -1.561),
                ...
                threeBallOrangePartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-0.669, -2.386), Rotation2.fromDegrees(-88.5))
                                                .lineTo(new Vector2(-0.66, -3.417), Rotation2.fromDegrees(-90.0))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
                ...
                threeBallTwoPreloadOrangePartTwo = new Trajectory(
                                new SimplePathBuilder(new Vector2(-0.66, -3.417), Rotation2.fromDegrees(-90.0))
                                                .lineTo(new Vector2(-3.518, -3.268), Rotation2.fromDegrees(34.88))
                                                .arcTo(new Vector2(-3.778, -2.358), new Vector2(-3.492, -2.768))
                                                .lineTo(new Vector2(-3.34, -2.053)).build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                threeBallOrangePartTwo = new Trajectory(
                                new SimplePathBuilder(new Vector2(-0.66, -3.417), Rotation2.fromDegrees(-90.0))
                                                .lineTo(new Vector2(-3.200, -3.284), Rotation2.fromDegrees(34.88))
                                                .arcTo(new Vector2(-3.950, -2.600), new Vector2(-3.150, -2.485))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
                ...
                fiveBallTwoPreloadOrangePartOne = new Trajectory(
                                new SimplePathBuilder(new Vector2(-3.34, -2.053), Rotation2.fromDegrees(34.88))
                                                .lineTo(new Vector2(-5.34, -2.293), Rotation2.fromDegrees(-131.25))
                                                .lineTo(new Vector2(-7.153, -2.511)).build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                fiveBallTwoPreloadOrangePartTwo = new Trajectory(
                                new SimplePathBuilder(new Vector2(-7.153, -2.511), Rotation2.fromDegrees(-131.25))
                                                .lineTo(new Vector2(-6.792, -2.166)).build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                fiveBallTwoPreloadOrangePartThree = new Trajectory(
                                new SimplePathBuilder(new Vector2(-6.792, -2.166), Rotation2.fromDegrees(-131.25))
                                                .lineTo(new Vector2(-2.5, -2.5), Rotation2.fromDegrees(45.0)).build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
                ...
                fiveBallOrangePartThree = new Trajectory(
                                new SimplePathBuilder(new Vector2(-6.669, -2.336), Rotation2.fromDegrees(-131.25))
                                                .lineTo(new Vector2(-2.500, -2.500), Rotation2.fromDegrees(45.0))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);

                fiveBallDefensivePartThree = new Trajectory(
                                new SimplePathBuilder(new Vector2(-6.669, -2.336), Rotation2.fromDegrees(-131.25))
                                                .lineTo(new Vector2(-4.127, -0.851), Rotation2.fromDegrees(16.4))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
                ...
                sixBallOrangePartTwo = new Trajectory(
                                new SimplePathBuilder(new Vector2(-0.66, -3.417), Rotation2.fromDegrees(-90.0))
                                                ...
                                                .arcTo(new Vector2(-3.95, -2.6), new Vector2(-3.158, -2.485),
                                                                Rotation2.fromDegrees(34.88))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
                ...
                sixBallOrangePartFive = new Trajectory(
                                new SimplePathBuilder(new Vector2(-6.853, -2.511), Rotation2.fromDegrees(-131.25))
                                                ...
                                                .arcTo(new Vector2(-3.593, 2.667), new Vector2(-4.960, 1.165),
                                                                Rotation2.fromDegrees(-32.13))
                                                .build(),
                                trajectoryConstraints, SAMPLE_DISTANCE);
        ...
        public Trajectory getFiveBallTwoPreloadOrangePartOne() {
                return fiveBallTwoPreloadOrangePartOne;
        }

        public Trajectory getFiveBallTwoPreloadOrangePartTwo() {
                return fiveBallTwoPreloadOrangePartTwo;
        }

        public Trajectory getFiveBallTwoPreloadOrangePartThree() {
                return fiveBallTwoPreloadOrangePartThree;
        }
