...
public final class Mk4SwerveModuleHelper {
    ...
    public static SwerveModule createFalcon500(
        ...
        return createFalcon500(container, new Mk4ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset, canBusName);
    }
    ...
    public static SwerveModule createFalcon500(
        ...
        return createFalcon500(new Mk4ModuleConfiguration(), gearRatio, driveMotorPort, steerMotorPort, steerEncoderPort, steerOffset, canBusName);
    }
